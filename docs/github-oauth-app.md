...
| **Authorization callback URL** | `https://thehome-sketchpad.kempenich.dev/github/callback` |
...
- The callback URL shows `https://thehome-sketchpad.kempenich.dev/github/callback`
...
- The callback URL (`/github/callback`) is where GitHub redirects users after they authorize the app. The FastMCP server handles this redirect in Phase 2.
